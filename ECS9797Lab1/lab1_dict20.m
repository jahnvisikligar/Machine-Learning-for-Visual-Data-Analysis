...
%Jahnvi'scode____210538601
index_train = zeros(size(TrainMat,1),1); % initalizing with size of training samples
index_test = zeros(size(TestMat,1),1); % initalizing with size of test samples
